...
<!--#include virtual="/mobile/html/inc/gnb.asp"-->
    <div class="container" id="sk">
        ...
        <div class="invitation_content">
            ...
            <div class="invi_btn">
                <button type="button" class="btn btn-primary">대중교통 &rharu;</button>
                <button type="button" class="btn btn-primary">승용차 &rharu;</button>
                <button type="button" class="btn btn-primary">인천공항 &rharu;</button>
            </div>
