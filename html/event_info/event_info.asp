...
<style type="text/css">
  #sk .event_contetnt strong{
    font-size: 28px;
  }
  #sk .panel .panel-heading:first-child{
    padding: 10px 15px;
    border-bottom: 1px solid #ddd;
    border-top-left-radius: 3px;
    border-top-right-radius: 3px;
  }
  #sk .panel .panel-heading, #sk .panel .panel-body {
    border-bottom : 1px #ddd solid;
  }
  #sk .panel .panel-heading {
    font-weight: bold;
  }
  #sk .panel .panel-body.cen {
    text-align: center;

  }
  #sk .panel .panel-body .impact{
    color:#1866B1;
  }
        ...
        <div class="event_content">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <span class="impact">
                  <strong>
                    미래를 향한 도전 - 변화와 혁신<br />(Challenge for the next 25 years - Innovation and Change)
                  </strong>
                </span>
              </div>
              <div class="panel-heading"><span>주관</span></div>
              <div class="panel-body cen small">
                <img src="/mobile/lib/images/event_info/koitalogo.gif" alt="한국산업기술진흥협회 마크">
              </div>
              <div class="panel-heading"><span>후원</span></div>
              <div class="panel-body cen">
                ...
                <img src="/mobile/lib/images/event_info/event_info7.gif" style="padding-left: 4px;" alt="jria 마크">
              </div>
